...
%Author Muhammad Mudassir Shakeel
%email: mudassir.shakeel786@gmail.com
%Area of expertise: Electrical, Electronics, Mechanical and Mechatronics
%Engineering
%Softwares: MATLAB/Simulink, Arduino, Solidworks, Proteus, Tinkercad and
%Fluidsim etc
clear all
clc
...
legend('Path','Optimized Path using RRT')
